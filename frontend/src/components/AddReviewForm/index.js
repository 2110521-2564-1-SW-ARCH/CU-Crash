...
export default function AddReviewForm({ onSubmit, form }) {
  ...
  return (
    <Form onSubmit={onSubmit}>

      {
        form == "instructor" ?
          <Form.Group controlId="ControlTextarea">
            <Form.Label className="justify-content-md-center">Instructor</Form.Label>
            <Form.Control
              type="textarea"
      ...
      {
        form == "instructor" ?
          <Form.Group className="justify-content-md-center mt-3" controlId="ControlTextarea">
      ...
      <Form.Group controlId="exampleForm.ControlTextarea1">
        <Form.Label className="justify-content-md-center mt-3">Review</Form.Label>
        <Form.Control
          as="textarea"
          rows={5}
          value={body}
